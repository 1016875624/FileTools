...
public class FileController{
	FileTool fileTool=new FileToolImpl();
	public void copy() {
	...
	public File getOnlyFile(String title) {
		JFileChooser fileChooser = new JFileChooser("D:\\");
		fileChooser.setDialogTitle(title);
		fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
	...
	public File getOnlyFileInWindows(String title) {
	    ...
	    if (dialog.getFiles().length>0) {
	    	System.out.println(dialog.getFiles()[0].getAbsolutePath());
	...
	public static void main(String[] args) {
		...
		//fileController.copy();
		fileController.getOnlyFileInWindows("12345");
